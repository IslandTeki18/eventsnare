...
export function StripeIcon(props: IconProps) {
  return <BrandIcon {...props} path={STRIPE_PATH} />
}
...
export function ShopifyIcon(props: IconProps) {
  return <BrandIcon {...props} path={SHOPIFY_PATH} />
}

export function ClerkIcon(props: IconProps) {
  return <BrandIcon {...props} path={CLERK_PATH} />
}

export function ResendIcon(props: IconProps) {
  return <BrandIcon {...props} path={RESEND_PATH} />
}
